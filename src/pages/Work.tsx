...
const projects = [
	...
	},
	{
		...
		title: 'TradeCore',
		category: 'ERP',
		type: 'Supply Chain ERP',
		desc: 'End-to-end supply chain management platform streamlining procurement, inventory, and vendor relations for a multinational trading company.',
		tags: ['React', 'PostgreSQL', 'Docker', 'Redis'],
		year: '2024',
		result: '−28%',
		resultLabel: 'procurement costs',
		size: 'small',
	},
];
