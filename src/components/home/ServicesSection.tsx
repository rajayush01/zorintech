...
const services = [
   {
    ...
    number: "01",
    title: "ERP Solutions",
    desc: "End-to-end ERP systems designed for schools, colleges, hospitals, and organizations to manage operations, data, and reporting from a single platform.",
  ...
  },
  {
    ...
    desc: "We design and develop high-performance business websites focused on speed, usability, and conversions, with ongoing maintenance for long-term reliability.",
  ...
  },
  {
    ...
    desc: "Custom e-commerce platforms with seamless payments, inventory control, order management, and scalable backend systems.",
  ...
  },
  {
    ...
    desc: "We design and build secure, scalable mobile applications tailored to business workflows, with seamless performance across devices.",
  ...
  },
  {
    ...
    desc: "We build secure, scalable web applications and admin dashboards to manage operations, users, data, and workflows efficiently.",
  ...
  },
  {
    ...
    desc: "Tailor-made software solutions built to automate processes, reduce manual work, and solve specific business problems.",
    tags: ["Automation Tools", "Internal Systems", "Custom Portals", "Scalable Architecture"],
    metric: "10×",
    metricLabel: "productivity gain",
    stat1: { value: "30+", label: "Software built" },
